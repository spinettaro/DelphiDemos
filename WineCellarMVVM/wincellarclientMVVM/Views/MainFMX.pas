...
type
  ...
  protected
    ...
    procedure SetLoadingView(const AValue: Boolean);
  public
    { Events declarations }
...
procedure TTabbedForm.OnLoadingEvent(AEvent: TLoadingEvent);
begin
  try
    SetLoadingView(AEvent.Wait);
  finally
    AEvent.Free;
  end;
end;
...
begin
  try
    ...
    WinesAdapter.SetList(FWineViewModel.CurrentWines);
...
procedure TTabbedForm.SetLoadingView(const AValue: Boolean);
begin
  WaitRectangle.Visible := AValue;
